...
class TestProfilesCommand:
    def test_profiles_list_command(self):
        ...
        with runner.isolated_filesystem():
            ...
            init_result = runner.invoke(
                main, ["init", "--name", "profiles-test", "--non-interactive"]
            )
    ...
    def test_profiles_list_detailed_command(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "detailed-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0
    ...
    def test_profiles_validate_command(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "validate-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0

            # profiles validate development 실행
            validate_result = runner.invoke(
                main, ["profiles", "validate", "development"]
            )
    ...
    def test_profiles_validate_all_command(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "validate-all-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0
    ...
    def test_profiles_show_command(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "show-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0
    ...
    def test_profiles_show_merged_command(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "show-merged-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0

            # profiles show development --merged 실행
            show_result = runner.invoke(
                main, ["profiles", "show", "development", "--merged"]
            )
            assert show_result.exit_code == 0
    ...
    def test_profiles_validate_nonexistent_profile(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "nonexistent-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0

            # 존재하지 않는 프로파일 검증
            validate_result = runner.invoke(
                main, ["profiles", "validate", "nonexistent"]
            )
    ...
    def test_profiles_show_nonexistent_profile(self):
        ...
        with runner.isolated_filesystem():
            # 프로젝트 초기화
            init_result = runner.invoke(
                main, ["init", "--name", "nonexistent-show-test", "--non-interactive"]
            )
            assert init_result.exit_code == 0
