...
class ValidatorMixin:
    ...
    def validate_path_exists(cls, v: str, must_exist: bool = False) -> str:
        ...
        try:
            ...
            raise ValueError(f"invalid path '{v}' - contains invalid characters or traversal attempts")
    ...
    @classmethod
    def validate_non_empty_list(cls, v: List[Any], field_name: str = "list") -> List[Any]:
