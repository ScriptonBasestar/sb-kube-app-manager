...
> **대상**: v0.7.x 사용자가 v0.8.0으로 마이그레이션 시 발생하는 chart 충돌 문제
> **난이도**: 쉬움
> **소요 시간**: 5-15분
...
2. **동일 Chart, 다른 버전**: `redis:18.0.0`과 `redis:19.0.0`
...
2. **FAQ**: [docs/07-troubleshooting/faq.md](./faq.md)
3. **GitHub Issues**: [sb-kube-app-manager/issues](https://github.com/your-org/sb-kube-app-manager/issues)
