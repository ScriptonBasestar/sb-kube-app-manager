...
> **대상**: AI 에이전트, 자동화 스크립트, CI/CD 파이프라인
> **버전**: v0.7.0+
> **난이도**: 쉬움
> **소요 시간**: 10-15분
...
| 명령어 | Human 포맷 | LLM 포맷 | 절감율 | JSON 포맷 |
|--------|-----------|---------|--------|-----------|
| `status` | 500 | 100 | 80% | 120 |
| `history` | 1200 | 200 | 83% | 250 |
| `validate` | 800 | 150 | 81% | 180 |
| `rollback` | 600 | 120 | 80% | 140 |
