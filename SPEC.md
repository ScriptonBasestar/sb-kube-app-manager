...
### 1.2 프로젝트 목적
SBKube는 k3s 환경에서 Kubernetes 애플리케이션의 배포 자동화를 위한 CLI 도구입니다. Helm 차트, YAML 매니페스트, Git 리포지토리 등 다양한 소스를 통합하여 일관된 배포 워크플로우를 제공합니다.

### 1.3 주요 사용 사례
- **웹호스팅/서버호스팅 DevOps 인프라**: ScriptonBasestar의 실무 환경에서 활용
- **내부 SaaS 플랫폼**: Helm 기반 배포 자동화
- **사용자 정의 YAML 템플릿**: Git 소스 통합 배포
- **오픈소스 DevOps 도구**: 테스트베드 및 공통 기반 제공

### 1.4 핵심 가치
- **일관성**: 다양한 소스를 통합한 단일 배포 인터페이스
- **자동화**: 수동 작업 최소화를 통한 배포 효율성 향상
- **확장성**: 다양한 애플리케이션 타입 및 배포 방법 지원
- **안정성**: 상태 관리 및 롤백 기능을 통한 안전한 배포
