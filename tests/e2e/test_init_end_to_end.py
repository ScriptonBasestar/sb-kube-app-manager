...
class TestInitEndToEnd:
    ...
    def test_init_output_consistency(self):
        ...
        with runner.isolated_filesystem():
            ...
            # 주요 단계별 메시지 확인
            assert any('새 프로젝트 초기화를 시작합니다' in line for line in output_lines)
            ...
            assert any('프로젝트 초기화가 완료되었습니다' in line for line in output_lines)
    ...
    def test_init_file_content_validation(self):
        ...
        with runner.isolated_filesystem():
            ...
            # values 파일 검증
            with open('values/validation-test-values.yaml', 'r') as f:
