...
from sbkube.exceptions import ConfigValidationError, FileOperationError
from .base_model import ConfigLoader
from .config_model_v2 import AppGroupScheme, AppInfoScheme
...
class ConfigManager:
    ...
    def __init__(self, base_dir: Union[str, Path], schema_dir: Optional[Union[str, Path]] = None):
        """
    ...
    def _load_with_inheritance(self, config_path: Path, parent_path: str) -> Dict[str, Any]:
        """
