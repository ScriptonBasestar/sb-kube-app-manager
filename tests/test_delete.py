...
def test_delete_action_app(mock_kubectl_check, runner: CliRunner, create_sample_config_yaml, create_sample_kubectl_manifest_file, base_dir, app_dir, caplog):
    """
    ...
    manifest_file = create_sample_kubectl_manifest_file  # manifest 파일 생성
