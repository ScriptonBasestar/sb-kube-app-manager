...
SBKube는 LLM(Large Language Model) 에이전트가 효율적으로 사용할 수 있도록 다양한 출력 포맷을 지원합니다. 인간 친화적인 Rich Console 출력 외에도 토큰을 절약하고 파싱이 쉬운 간결한 출력 포맷을 제공합니다.
...
|------|------------|----------|-----------|---------------------|
| **간단한 배포 (3 apps)** | 500-1000 | 80-100 | 150-200 | 80-90% |
| **복잡한 배포 (10 apps)** | 2000-3000 | 200-300 | 400-600 | 85-90% |
| **상태 확인** | 300-500 | 50-80 | 100-150 | 80-85% |
| **에러 보고** | 800-1200 | 120-180 | 200-300 | 80-85% |
