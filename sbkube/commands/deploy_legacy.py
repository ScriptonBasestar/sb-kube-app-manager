"""
DEPRECATED: This file has been replaced by deploy.py (formerly deploy_v2.py)

This legacy deploy command is kept for backward compatibility only.
New code should use deploy.py which provides:
