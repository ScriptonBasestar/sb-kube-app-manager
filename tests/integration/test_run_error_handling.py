...
from sbkube.commands.run import cmd, RunExecutionError
...
class TestRunCLIErrorHandling:
    ...
    @patch('sbkube.commands.prepare.PrepareCommand.execute')
    @patch('sbkube.commands.run.RunCommand.execute_pre_hook')
    def test_template_step_failure_output(self, mock_pre_hook, mock_prepare, mock_build, mock_template):
    ...
    @patch('sbkube.commands.prepare.PrepareCommand.execute')
    @patch('sbkube.commands.run.RunCommand.execute_pre_hook')
    def test_deploy_step_failure_output(self, mock_pre_hook, mock_prepare, mock_build, mock_template, mock_deploy):
        """deploy 단계 실패 출력 테스트"""
    ...
    @patch('sbkube.commands.prepare.PrepareCommand.execute')
    @patch('sbkube.commands.run.RunCommand.execute_pre_hook')
    def test_step_failure_with_only_option(self, mock_pre_hook, mock_prepare, mock_build, mock_template):
    ...
    def test_suggestions_numbering(self, mock_pre_hook, mock_prepare):
        ...
        numbered_lines = [line for line in lines if line.strip().startswith(('1.', '2.', '3.', '4.', '5.'))]
