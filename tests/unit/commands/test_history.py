...
class TestHistoryManagement:
    ...
    def test_failure_pattern_detection(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert any(pattern['type'] == 'frequent_failure_step' for pattern in failure_analysis['patterns'])
    ...
    def test_time_pattern_analysis(self):
        ...
        # 시간대별 패턴이 감지되어야 함
        time_patterns = [p for p in failure_analysis['patterns'] if p['type'] == 'time_pattern']
    ...
    def test_profile_performance_analysis(self):
        ...
        assert profile_perf['development']['avg_duration'] < profile_perf['production']['avg_duration']
