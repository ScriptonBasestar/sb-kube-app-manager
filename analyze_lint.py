...
exit_code, stdout, stderr = run_command("uv run ruff check sbkube tests --diff --exclude migrations --exclude node_modules --exclude examples")
...
# Run mypy
print("\n2. Running mypy...")
exit_code, stdout, stderr = run_command("uv run mypy sbkube --ignore-missing-imports --exclude migrations --exclude node_modules --exclude examples")
...
# Run bandit
print("\n3. Running bandit...")
exit_code, stdout, stderr = run_command("uv run bandit -r sbkube --skip B101,B404,B603,B607,B602 --severity-level medium --quiet --exclude '*/tests/*,*/scripts/*,*/debug/*,*/examples/*'")
...
exit_code, stdout, stderr = run_command("uv run mdformat --check --diff *.md docs/**/*.md --wrap 120")
