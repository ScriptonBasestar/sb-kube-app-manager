...
from sbkube.utils.profile_manager import (
    ConfigPriority,
    ProfileInheritance,
    ProfileManager,
)
...
class TestConfigPriority:
    def test_apply_overrides(self):
        ...
        env_overrides = {"apps": [{"name": "app1", "replicas": 3}]}

        cli_overrides = {"namespace": "production", "settings": {"timeout": 30}}
    ...
    def test_deep_merge(self):
        """딥 머지 테스트"""
        base = {
            "level1": {"level2": {"value1": "base", "value2": "keep"}, "simple": "base"}
        }

        override = {
            "level1": {
                "level2": {"value1": "override", "value3": "new"},
                "simple": "override",
            }
        }
