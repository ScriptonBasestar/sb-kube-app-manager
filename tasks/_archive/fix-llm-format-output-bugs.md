...
verification-summary: |
  ...
  - Bug 1: format_type propagated via ctx.obj (apply.py:188-189)
  - Bug 2: unified config detection skips SourceScheme (app_dir_resolver.py:78-82)
  - Bug 3: error output if/else logic (output_formatter.py:237-241)
  - Bug 4: label_for_state replaces emojis (output_formatter.py:262-271)
  - Bug 5: progressbar disabled for non-human formats (apply.py:400, 1351)
  - Bug 6: _strip_markup removes Rich tags + emojis (output_manager.py:92-102)
