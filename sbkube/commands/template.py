...
def cmd(app_config_dir_name: str, output_dir_name: str, base_dir: str, cli_namespace: str, config_file_name: str, app_name: str):
    ...
    for app_info in app_info_list_to_template:
        ...
        try:
            return_code, stdout, stderr = run_command(helm_template_cmd, check=False, timeout=60)
            ...
            if return_code == 0:
                ...
                console.print(f"[red]❌ 앱 '{app_name}': `helm template` 실행 실패 (exit code: {return_code}):[/red]")
