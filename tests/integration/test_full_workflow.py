...
class TestFullWorkflow:
    ...
    def test_helm_workflow(self, sbkube_project, helm_binary, monkeypatch):
        ...
        result = runner.invoke(main, ['prepare', '--base-dir', str(sbkube_project), '--app-dir', 'config'])
        ...
        result = runner.invoke(main, ['build', '--base-dir', str(sbkube_project), '--app-dir', 'config'])
    ...
    @pytest.mark.requires_helm
    def test_workflow_with_real_k8s(self, sbkube_project, k8s_cluster, k8s_namespace, helm_binary):
        ...
        commands = [
            ...
            ['deploy', '--base-dir', str(sbkube_project), '--app-dir', 'config', 
    ...
    def test_mixed_workflow(self, tmp_path):
        ...
        config = {
            ...
            "apps": [
                ...
                },
                {
                    ...
                    "type": "exec",
                    "specs": {
                        "commands": ["echo 'Hello from sbkube'"]
                    }
                }
            ]
        }
        ...
        result = runner.invoke(main, [
            'build', '--base-dir', str(project_dir), '--app-dir', 'config'
        ])
...
class TestErrorScenarios:
    ...
    def test_missing_chart_recovery(self, tmp_path):
        ...
        result = runner.invoke(main, [
            'deploy', '--base-dir', str(project_dir), '--app-dir', 'config'
        ])
    ...
    def test_deployment_tracking(self, tmp_path):
        ...
        config = {
            ...
            "apps": [{
                ...
                "type": "exec",
                "specs": {
                    "commands": ["echo 'Tracked deployment'"]
                }
            }]
        }
        with open(config_dir / "config.yaml", 'w') as f:
