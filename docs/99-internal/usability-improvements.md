...
> **완료**: `sbkube apply` 명령어로 변경 완료 (2025-01-20). Kubernetes의 `kubectl apply`와의 일관성을 위해 기존 `sbkube run`을 `sbkube apply`로 변경했습니다.
...
**사용 가능 여부:** ✅ `sbkube apply`로 즉시 사용 가능
...
| Phase | 완성도 | 핵심 기능 | 비고 |
|-------|--------|----------|------|
| Phase 1 | 100% ✅ | apply, init | 완료 - 즉시 사용 가능 |
