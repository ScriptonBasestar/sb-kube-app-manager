...
from typing import Any, Dict, Optional, TypeVar, Generic, Type, Union, List
...
class ConfigBaseModel(BaseModel, ValidatorMixin):
    ...
    @classmethod
    def from_dict(cls: Type[T], data: Dict[str, Any], context: Optional[Dict[str, Any]] = None) -> T:
        """
    ...
    def merge_with(self: T, other: Optional[Union[Dict[str, Any], T]], deep: bool = True) -> T:
        """
